...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Container With Most Water}]
#include <algorithm>
#include <vector>
...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Contains Duplicate}]
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Counting Bits}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Course Schedule}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Decode Ways}]
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Linked List Cycle}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Encode and Decode Strings}]
#include <string>
#include <vector>
