...
\begin{lstlisting}[style=compactcode,caption={Complete solution: Unique Paths}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Valid Anagram}]
#include <array>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Valid Palindrome}]
#include <cctype>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Valid Parentheses}]
#include <stack>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Validate BST}]
#include <limits>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Word Break}]
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Word Search II}]
#include <array>
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Word Search}]
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Search in Rotated Sorted Array}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Longest Increasing Subsequence}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Climbing Stairs}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Invert Binary Tree}]
#include <utility>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Pacific Atlantic Water Flow}]
#include <vector>
