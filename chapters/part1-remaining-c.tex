...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ data structure: MedianFinder}]
#include <functional>
#include <queue>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Find Minimum in Rotated Sorted Array}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Graph Valid Tree}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Group Anagrams}]
#include <algorithm>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: House Robber}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: House Robber II}]
#include <algorithm>
#include <vector>
