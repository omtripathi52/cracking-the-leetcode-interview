...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Maximum Subarray}]
#include <algorithm>
#include <vector>
...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Maximum Product Subarray}]
#include <algorithm>
#include <vector>
...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Character Replacement}]
#include <algorithm>
#include <array>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Longest Palindromic Substring}]
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Longest Substring Without Repeats}]
#include <algorithm>
#include <array>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Palindromic Substrings}]
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Meeting Rooms}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Jump Game}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Maximum Depth of Binary Tree}]
#include <algorithm>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Kth Smallest in a BST}]
#include <stack>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: LCA of a BST}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Meeting Rooms II}]
#include <algorithm>
#include <functional>
#include <queue>
#include <vector>
