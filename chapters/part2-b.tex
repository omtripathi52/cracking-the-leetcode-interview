...
\begin{lstlisting}[style=compactcode,caption={Complete solution: Non-overlapping Intervals}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Merge Intervals}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Insert Interval}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Number of Islands}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Connected Components}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Longest Consecutive Sequence}]
#include <algorithm>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Merge Two Sorted Lists}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Merge K Sorted Lists}]
#include <queue>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Longest Common Subsequence}]
#include <algorithm>
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Minimum Window Substring}]
#include <array>
#include <limits>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Missing Number}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete solution: Number of 1 Bits}]
#include <cstdint>
