...
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Maximum Subarray}]
#include <algorithm>
#include <vector>
...
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Maximum Product Subarray}]
#include <algorithm>
#include <vector>
...
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Character Replacement}]
#include <algorithm>
#include <array>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Longest Palindromic Substring}]
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Longest Substring Without Repeats}]
#include <algorithm>
#include <array>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Palindromic Substrings}]
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Meeting Rooms}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Jump Game}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Maximum Depth of Binary Tree}]
#include <algorithm>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Kth Smallest in a BST}]
#include <stack>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: LCA of a BST}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Meeting Rooms II}]
#include <algorithm>
#include <functional>
#include <queue>
#include <vector>
