...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Product of Array Except Self}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Remove Nth Node From End}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Reorder List}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Reverse Linked List}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Reverse Bits}]
#include <cstdint>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Rotate Image}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Same Tree}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Serialize and Deserialize Tree}]
#include <sstream>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Set Matrix Zeroes}]
#include <vector>
...
\begin{tikzpicture}[font=\small,>={Stealth[length=2.2mm,width=1.55mm]}]
  ...
  \foreach \cell/\num in {m-1-1/1,m-1-2/2,m-1-3/3,m-2-3/4,
    ...
    \node[font=\tiny,text=orange,anchor=north east] at (\cell.north east) {\num};
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Spiral Matrix}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Subtree of Another Tree}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Sum of Two Integers}]
#include <cstdint>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete solution: Top K Frequent Elements}]
#include <queue>
