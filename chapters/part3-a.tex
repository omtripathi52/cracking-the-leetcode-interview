...
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Product of Array Except Self}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Remove Nth Node From End}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Reorder List}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Reverse Linked List}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Reverse Bits}]
#include <cstdint>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Rotate Image}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Same Tree}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Serialize and Deserialize Tree}]
#include <sstream>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Set Matrix Zeroes}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Spiral Matrix}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Subtree of Another Tree}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Sum of Two Integers}]
#include <cstdint>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Top K Frequent Elements}]
#include <queue>
