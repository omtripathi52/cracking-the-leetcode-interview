...
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Unique Paths}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Valid Anagram}]
#include <array>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Valid Palindrome}]
#include <cctype>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Valid Parentheses}]
#include <stack>
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Validate BST}]
#include <limits>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Word Break}]
#include <string>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Word Search II}]
#include <array>
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Word Search}]
#include <string>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Search in Rotated Sorted Array}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Longest Increasing Subsequence}]
#include <algorithm>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Climbing Stairs}]
using namespace std;
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Invert Binary Tree}]
#include <utility>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,caption={Complete C++ solution: Pacific Atlantic Water Flow}]
#include <vector>
