...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Binary Tree Level Order Traversal}]
#include <queue>
#include <utility>
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Binary Tree Maximum Path Sum}]
#include <algorithm>
#include <limits>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Clone Graph}]
...
\begin{tikzpicture}[font=\small]
  \foreach \x/\v in {0/0,1/1,2/1,3/2,4/2,5/1,6/2,7/2,8/3,9/3,10/2,11/3} {
    ...
    \node[below=1mm of d\x,font=\tiny] {\x};
  }
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Coin Change}]
#include <algorithm>
#include <vector>
...
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Combination Sum IV}]
#include <vector>
...
\subsection{C++ Implementation}
\begin{lstlisting}[style=compactcode,float=htbp,caption={Complete C++ solution: Construct Binary Tree}]
#include <unordered_map>
#include <vector>
