...
Trace an all-negative tree such as root \(-3\) with children \(-2\) and
\(-5\). Explain why child gains may be clamped to zero while the global answer
must still contain at least one real node.
\end{revisionbox}
\chaptercheckpoint
